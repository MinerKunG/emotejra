...
public class SerializableConfig {
    ...
    // ลบอันที่ซ้ำออก เหลือแค่อันเดียวแบบนี้ครับ
    ...
    public static class IntConfig extends ConfigEntry<Integer> {
        public IntConfig(String name, String oldconfig, Integer defVal, boolean hasTooltip, List<ConfigEntry<?>> collection) {
            super(name, oldconfig, defVal, hasTooltip, collection);
        }

        public IntConfig(String name, Integer defVal, boolean hasTooltip, List<ConfigEntry<?>> collection) {
            super(name, defVal, hasTooltip, collection);
        }

        public IntConfig(String name, Integer defVal, List<ConfigEntry<?>> collection, boolean hidden) {
            super(name, defVal, collection, hidden);
        }
    }
